...
//  JobsMatch
//
//  Created by ivans Android on 3/30/24.
//
...
struct slideToUnlockView: View {
    ...
    @Binding var showSlideToUnlockView: Bool
...
#Preview {
    slideToUnlockView(showSlideToUnlockView: .constant(false))
}
